...
| `17-spending-view-edit-mode.spec.ts`   | Spending view/edit toggle: mode shared with investments + persisted, category popover inside a grid cell, inline note edit saves |
